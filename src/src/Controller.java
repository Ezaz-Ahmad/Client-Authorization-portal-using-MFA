...
public class Controller {
    ...
    private static SecurityLevel stringToSecurityLevel(String level) {
        switch(level) {
            ...
            default: // "Unclassified" or anything else
    ...
    // Process the view Meetingc Minutes
