        ...
        while (true) {
            ...
            switch (choice) {
                case 1: // For login choice
                    ...
                    // Verify if the entered password matches with the stored one for the given username
                    if(Controller.verifyPassword(username, password)) {
                        token = Controller.generateToken(username);
                        if(token != null && !token.isEmpty()) { // Ensures the token is valid
                ...
                case 3:
                    ...
                    System.out.print("Enter new security level (TOP_SECRET / SECRET / UNCLASSIFIED) : ");
